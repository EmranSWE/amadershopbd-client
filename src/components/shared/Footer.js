...
import apple from "../../Assets/footer/apple-store_1.png";
import app from "../../Assets/footer/app-gallery.png";
...
const Footer = () => {
  ...
  <div>
    <span className="footer-title">AmadershopBD</span> 
    <span>Emran soft tech Bangladesh Limited</span>
    <div className='flex items-center'>
        <FaMapMarkerAlt />
        <h1>House No:880, Road:#3, Arshinagar, 
            <br />
            Bosila,Mohammadpur,Dhaka-1207, Bangladesh</h1>
    </div>
    <div className='flex items-center'>
        <BsFillTelephoneFill />
        <h1>+8801838223344</h1>
    ...
    <div className='flex items-center'>
        <GoMailRead />
        <h1>support@amadershopbd.com</h1>
    </div>
  </div> 
  <div>
    ...
    <a className="link link-hover">Why Shop With Us</a>
    <a className="link link-hover">Amadershop Store</a>
  </div> 
  ...
  <div>
    ...
    <a className="link link-hover">Amadershopbd Support</a>
  </div>
